...
# Получает данные о виртуальных машинах из vCentr'a через restapi,
# форматирует и приводи их в удобный для загрузки формат.
# Создает КЕ node и vmware_host_resource и загружает все в UCMDB
# в студию интеграции.
# Также из подготовленного XML парсятся дополнительные
# сведения и создаются КЕ - installed_software,
